...
from features_advanced import calculate_speed_kmh, build_advanced_features


class TestCalculateSpeedKmh(unittest.TestCase):
    """Test calculate_speed_kmh function"""
...
class TestBuildAdvancedFeatures(unittest.TestCase):
    ...
    def test_without_section2_data(self):
        """Test that Speed_kmh is None without Section 2 data"""
        dog_data = {
            'dog_name': 'SLOW PUP',
            'box': 2
        }
